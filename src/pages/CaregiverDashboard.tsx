...
import { ArrowLeft, User, Calendar, Clock, MessageSquare, AlertTriangle } from "lucide-react";
import { useBloodSugar } from "@/context/BloodSugarContext";
import { cn } from "@/lib/utils";

const CaregiverDashboard = () => {
  const navigate = useNavigate();
  const { readings, userProfile } = useBloodSugar();
  ...
  return (
    <div className="app-container">
      ...
      <main className="app-content">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-medium mb-4">Recent Abnormal Readings</h2>
              ...
              {abnormalReadings.slice(0, 5).map((reading, index) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start pr-8">
                    ...
                    <button className="mt-2 flex items-center text-app-primary bg-white px-3 py-1 rounded-md text-sm border border-app-primary/20 shadow-sm">
